/**
 * @file mint/hardware/i386/serial.h
 * @brief Serial header for the I386 architecture
 * 
 * 
 * @copyright
...
/**
 * TAKEN FROM: https://github.com/reactos/reactos/blob/master/sdk/include/reactos/drivers/serial/ns16550.h
 */
 ...
 */
#define RECEIVE_BUFFER_REGISTER     ((ULONG)((0x00)))
#define TRANSMIT_HOLDING_REGISTER   ((ULONG)((0x00)))
#define INTERRUPT_ENABLE_REGISTER   ((ULONG)((0x01)))
#define INTERRUPT_IDENT_REGISTER    ((ULONG)((0x02)))
#define FIFO_CONTROL_REGISTER       ((ULONG)((0x02)))
#define LINE_CONTROL_REGISTER       ((ULONG)((0x03)))
#define MODEM_CONTROL_REGISTER      ((ULONG)((0x04)))
#define LINE_STATUS_REGISTER        ((ULONG)((0x05)))
#define MODEM_STATUS_REGISTER       ((ULONG)((0x06)))
#define SCRATCH_REGISTER            ((ULONG)((0x07)))

#define DIVISOR_LATCH_LSB           ((ULONG)((0x00)))
#define DIVISOR_LATCH_MSB           ((ULONG)((0x01)))
#define SERIAL_REGISTER_LENGTH      ((ULONG)(7))
