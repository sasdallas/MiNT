/**
 * @file include/mint/bugcodes.h
 * @brief Scraped bugcode list
 */

#include <HeaderBase.h>

#ifndef __MINT_BUGCODES_H__
#define __MINT_BUGCODES_H__ 1
...
#define WHEA_UNCORRECTABLE_ERROR 0x00000124
...
#define WIN32K_CRITICAL_FAILURE 0x00000164
...
#define CLUSTER_CSV_CLUSSVC_DISCONNECT_WATCHDOG 0x00000170
#define CRYPTO_LIBRARY_INTERNAL_ERROR 0x00000171
...
#define EXCEPTION_ON_INVALID_STACK 0x000001AA
#define UNWIND_ON_INVALID_STACK 0x000001AB
...
#define BUGCODE_MBBADAPTER_DRIVER 0x000001DD
#define BUGCODE_WIFIADAPTER_DRIVER 0x000001DE
#define PROCESSOR_START_TIMEOUT 0x000001DF
#define VIDEO_DXGKRNL_SYSMM_FATAL_ERROR 0x000001E4
#define ILLEGAL_ATS_INITIALIZATION 0x000001E9
#define SECURE_PCI_CONFIG_SPACE_ACCESS_VIOLATION 0x000001EA
#define DAM_WATCHDOG_TIMEOUT 0x000001EB
#define HANDLE_ERROR_ON_CRITICAL_THREAD 0x000001ED
#define KASAN_ENLIGHTENMENT_VIOLATION 0x000001F1
#define KASAN_ILLEGAL_ACCESS 0x000001F2
